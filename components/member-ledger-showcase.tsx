...
export default function MemberLedgerShowcase() {
  return (
    <section id="member-timeline" className="scroll-mt-20 bg-muted/30 px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <SectionHeading
          heading="See the Member Timeline in Action"
          subtitle="Open a member’s timeline to see their history in one place — admissions, room changes, charges, payments, deposits, complaints and other records. This is the member record, not the rent-collection screen."
        />
        <ProductVideo
